...
```
curl -fsSL "https://github.com/byrafael/.tmux/raw/refs/heads/master/install.sh#$(date +%s)" | bash
```

**Manual installation in `~`**
```
$ cd
$ git clone --single-branch https://github.com/byrafael/.tmux.git
...
```
$ git clone --single-branch https://github.com/byrafael/.tmux.git "/path/to/oh-my-tmux"
